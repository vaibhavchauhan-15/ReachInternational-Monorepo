...
export interface RotateCCWIconProps extends Omit<HTMLAttributes<HTMLDivElement>, "color"> {
  size?: number | string;
...
export { RotateCCWIcon, RotateCCWIcon as RotateCcwIcon, RotateCCWIcon as RotateCcw, RotateCCWIcon as RotateCCW };
