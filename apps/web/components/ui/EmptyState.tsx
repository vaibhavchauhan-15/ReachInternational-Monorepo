...
export function EmptyState({
  ...
  return (
    <div className={`group interactive-parent flex flex-col items-center justify-center gap-3 py-16 text-center ${className}`}>
      <div className="flex h-12 w-12 items-center justify-center rounded-full bg-[var(--color-hairline-soft-surface)] text-[var(--color-mute)] transition-transform duration-200">
