    ...
    >
      ...
      <section className="p-4 sm:p-5 rounded-2xl border border-[var(--color-hairline)] bg-[var(--color-canvas-elevated)] shadow-xs space-y-2.5 text-left">
        ...
        <div className="space-y-4 sm:space-y-6">
          ...
          {/* SECTION 1 */}
          {/* ========================================================================= */}
          <section id="section-1" className="p-4 sm:p-5 rounded-2xl border border-[var(--color-hairline)] bg-[var(--color-canvas-elevated)] shadow-xs space-y-3 text-left scroll-mt-14">
            ...
            <ul className="list-disc list-outside ml-4 sm:ml-5 space-y-1.5 text-xs sm:text-[13px] text-[var(--color-body)] leading-relaxed">
              <li>
                <strong>Enterprise Cloud Platform:</strong> The centralized cloud application accessible at <code className="text-[11px] font-mono bg-[var(--color-canvas)] px-1 py-0.5 rounded border border-[var(--color-hairline)]">{BRAND_WEBSITE_DISPLAY}</code> and associated APIs powering machine dispatch, maintenance tracking, and fleet analytics.
              </li>
              <li>
                <strong>Mobile Field Application:</strong> The hybrid and native mobile application (<code className="text-[11px] font-mono bg-[var(--color-canvas)] px-1 py-0.5 rounded border border-[var(--color-hairline)]">com.reachinternational.app</code>) distributed on Google Play Store, Apple App Store, and internal enterprise distribution channels.
              </li>
              <li>
            ...
            <p className="text-xs sm:text-[13px] text-[var(--color-body)] leading-relaxed text-left font-normal pt-1">
          ...
          {/* SECTION 2 */}
          {/* ========================================================================= */}
          <section id="section-2" className="p-4 sm:p-5 rounded-2xl border border-[var(--color-hairline)] bg-[var(--color-canvas-elevated)] shadow-xs space-y-3 text-left scroll-mt-14">
            <h2 className="text-sm sm:text-base font-bold text-[var(--color-ink)] tracking-tight text-left">
            ...
            <div className="space-y-3.5 pt-1">
              <div>
                <h3 className="text-xs sm:text-sm font-semibold text-[var(--color-ink)] mb-1">
              ...
              <div>
                ...
                <ul className="list-disc list-outside ml-4 sm:ml-5 space-y-1 text-xs sm:text-[13px] text-[var(--color-body)] leading-relaxed">
                  ...
                  <li>Aadhaar numbers recorded strictly with statutory 8-digit masking (<code className="text-[11px] font-mono bg-[var(--color-canvas)] px-1 py-0.5 rounded border border-[var(--color-hairline)]">XXXX-XXXX-1234</code>) in full compliance with UIDAI regulations. Reach International never collects or stores raw biometrics.</li>
          ...
          {/* SECTION 3 */}
          {/* ========================================================================= */}
          <section id="section-3" className="p-4 sm:p-5 rounded-2xl border border-[var(--color-hairline)] bg-[var(--color-canvas-elevated)] shadow-xs space-y-3 text-left scroll-mt-14">
            <h2 className="text-sm sm:text-base font-bold text-[var(--color-ink)] tracking-tight text-left">
            ...
            <ul className="list-disc list-outside ml-4 sm:ml-5 space-y-1.5 text-xs sm:text-[13px] text-[var(--color-body)] leading-relaxed">
              ...
              <li>
                <strong>Offline Queues & Background Sync:</strong> Data captured in remote or low-connectivity worksites is stored locally in encrypted storage (<code className="text-[11px] font-mono bg-[var(--color-canvas)] px-1 py-0.5 rounded border border-[var(--color-hairline)]">AsyncStorage</code> / SQLite) and synchronized securely upon network reconnection.
              </li>
            </ul>
          </section>
          ...
          {/* SECTION 4 */}
          {/* ========================================================================= */}
          <section id="section-4" className="p-4 sm:p-5 rounded-2xl border border-[var(--color-hairline)] bg-[var(--color-canvas-elevated)] shadow-xs space-y-3 text-left scroll-mt-14">
            <h2 className="text-sm sm:text-base font-bold text-[var(--color-ink)] tracking-tight text-left">
          ...
          {/* SECTION 5 */}
          {/* ========================================================================= */}
          <section id="section-5" className="p-4 sm:p-5 rounded-2xl border border-[var(--color-hairline)] bg-[var(--color-canvas-elevated)] shadow-xs space-y-3 text-left scroll-mt-14">
            <h2 className="text-sm sm:text-base font-bold text-[var(--color-ink)] tracking-tight text-left">
            ...
            <ul className="list-disc list-outside ml-4 sm:ml-5 space-y-1.5 text-xs sm:text-[13px] text-[var(--color-body)] leading-relaxed">
              ...
              <li>
                <strong>Role-Based Access Control (RBAC):</strong> System roles (<code className="text-[11px] font-mono bg-[var(--color-canvas)] px-1 py-0.5 rounded border border-[var(--color-hairline)]">super_admin</code>, <code className="text-[11px] font-mono bg-[var(--color-canvas)] px-1 py-0.5 rounded border border-[var(--color-hairline)]">admin</code>, <code className="text-[11px] font-mono bg-[var(--color-canvas)] px-1 py-0.5 rounded border border-[var(--color-hairline)]">manager</code>, <code className="text-[11px] font-mono bg-[var(--color-canvas)] px-1 py-0.5 rounded border border-[var(--color-hairline)]">supervisor</code>, <code className="text-[11px] font-mono bg-[var(--color-canvas)] px-1 py-0.5 rounded border border-[var(--color-hairline)]">hr</code>, <code className="text-[11px] font-mono bg-[var(--color-canvas)] px-1 py-0.5 rounded border border-[var(--color-hairline)]">operator</code>) possess strictly compartmentalized permissions. Sensitive personal KYC data is shielded from unauthorized peers.
              </li>
              <li>
              ...
              <li>
                <strong>Tamper-Evident Immutable Audit Trails:</strong> Modifications to machine hour readings, operator assignments, and account statuses produce immutable structured audit trails (<code className="text-[11px] font-mono bg-[var(--color-canvas)] px-1 py-0.5 rounded border border-[var(--color-hairline)]">logAudit</code>) containing actor ID, timestamp, and IP address.
              </li>
            </ul>
          </section>
          ...
          {/* SECTION 6 */}
          {/* ========================================================================= */}
          <section id="section-6" className="p-4 sm:p-5 rounded-2xl border border-[var(--color-hairline)] bg-[var(--color-canvas-elevated)] shadow-xs space-y-3 text-left scroll-mt-14">
            <h2 className="text-sm sm:text-base font-bold text-[var(--color-ink)] tracking-tight text-left">
            ...
            <p className="text-[11px] sm:text-xs text-[var(--color-mute)] leading-normal text-left pt-1">
          ...
          {/* SECTION 7 */}
          {/* ========================================================================= */}
          <section id="section-7" className="p-4 sm:p-5 rounded-2xl border border-[var(--color-hairline)] bg-[var(--color-canvas-elevated)] shadow-xs space-y-3 text-left scroll-mt-14">
            <h2 className="text-sm sm:text-base font-bold text-[var(--color-ink)] tracking-tight text-left">
          ...
          {/* SECTION 8 */}
          {/* ========================================================================= */}
          <section id="section-8" className="p-4 sm:p-5 rounded-2xl border border-[var(--color-hairline)] bg-[var(--color-canvas-elevated)] shadow-xs space-y-3 text-left scroll-mt-14">
            <h2 className="text-sm sm:text-base font-bold text-[var(--color-ink)] tracking-tight text-left">
            ...
            <div className="p-3.5 sm:p-4 rounded-xl border border-[var(--color-hairline)] bg-[var(--color-canvas)] space-y-2.5 mt-2">
              ...
              <ol className="list-decimal list-outside ml-4 sm:ml-5 space-y-1.5 text-xs sm:text-[13px] text-[var(--color-body)] leading-relaxed">
                <li>
                  <strong>In-App Self-Service:</strong> Open the ReachInternational App → Navigate to <em>Settings</em> → <em>Account Management</em> → Tap <strong>&quot;Request Account Deletion&quot;</strong>.
                </li>
                <li>
              ...
              <p className="text-[11px] sm:text-xs text-[var(--color-mute)] leading-normal pt-1 border-t border-[var(--color-hairline)]">
          ...
          {/* SECTION 9 */}
          {/* ========================================================================= */}
          <section id="section-9" className="p-4 sm:p-5 rounded-2xl border border-[var(--color-hairline)] bg-[var(--color-canvas-elevated)] shadow-xs space-y-3 text-left scroll-mt-14">
            <h2 className="text-sm sm:text-base font-bold text-[var(--color-ink)] tracking-tight text-left">
            ...
            <ul className="list-disc list-outside ml-4 sm:ml-5 space-y-1.5 text-xs sm:text-[13px] text-[var(--color-body)] leading-relaxed">
              <li>
                <strong>Authentication Session Cookies:</strong> <code className="text-[11px] font-mono bg-[var(--color-canvas)] px-1 py-0.5 rounded border border-[var(--color-hairline)]">sb-access-token</code> and <code className="text-[11px] font-mono bg-[var(--color-canvas)] px-1 py-0.5 rounded border border-[var(--color-hairline)]">sb-refresh-token</code> are essential for encrypted JWT session validation.
              </li>
              <li>
                <strong>Theme & Display Preferences:</strong> Stores user theme mode (<code className="text-[11px] font-mono bg-[var(--color-canvas)] px-1 py-0.5 rounded border border-[var(--color-hairline)]">light</code>, <code className="text-[11px] font-mono bg-[var(--color-canvas)] px-1 py-0.5 rounded border border-[var(--color-hairline)]">dark</code>, or <code className="text-[11px] font-mono bg-[var(--color-canvas)] px-1 py-0.5 rounded border border-[var(--color-hairline)]">system</code>).
              </li>
              <li>
          ...
          {/* SECTION 10 */}
          {/* ========================================================================= */}
          <section id="section-10" className="p-4 sm:p-5 rounded-2xl border border-[var(--color-hairline)] bg-[var(--color-canvas-elevated)] shadow-xs space-y-3 text-left scroll-mt-14">
            <h2 className="text-sm sm:text-base font-bold text-[var(--color-ink)] tracking-tight text-left">
          ...
          {/* SECTION 11 */}
          {/* ========================================================================= */}
          <section id="section-11" className="p-4 sm:p-5 rounded-2xl border border-[var(--color-hairline)] bg-[var(--color-canvas-elevated)] shadow-xs space-y-3 text-left scroll-mt-14">
            <h2 className="text-sm sm:text-base font-bold text-[var(--color-ink)] tracking-tight text-left">
          ...
          {/* SECTION 12 */}
          {/* ========================================================================= */}
          <section id="section-12" className="p-4 sm:p-5 rounded-2xl border border-[var(--color-hairline)] bg-[var(--color-canvas-elevated)] shadow-xs space-y-3 text-left scroll-mt-14">
            <h2 className="text-sm sm:text-base font-bold text-[var(--color-ink)] tracking-tight text-left">
          ...
          {/* SECTION 13 */}
          {/* ========================================================================= */}
          <section id="section-13" className="p-4 sm:p-5 rounded-2xl border border-[var(--color-hairline)] bg-[var(--color-canvas-elevated)] shadow-xs space-y-3 text-left scroll-mt-14">
            <h2 className="text-sm sm:text-base font-bold text-[var(--color-ink)] tracking-tight text-left">
            ...
            <div className="p-3.5 sm:p-4 rounded-xl border border-[var(--color-hairline)] bg-[var(--color-canvas)] space-y-3 mt-2">
              ...
              <div className="pt-2 border-t border-[var(--color-hairline)] text-[11px] sm:text-xs text-[var(--color-mute)] leading-normal">
