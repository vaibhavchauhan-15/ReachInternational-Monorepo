...
async function runTestSuite() {
  ...
  try {
    ...
    const { error: regErr } = await supabase.from("machine_hour_logs").insert({
      ...
      log_date: "2023-05-01",
      end_date: "2023-05-01",
      start_datetime: "2023-05-01T06:00:00+05:30",
      end_datetime: "2023-05-01T14:00:00+05:30",
      start_time: "06:00 AM",
      end_time: "02:00 PM",
      start_meter: 500,
    ...
    const { error: dupErr } = await supabase.from("machine_hour_logs").insert({
      ...
      log_date: "2023-05-02",
      end_date: "2023-05-02",
      start_datetime: "2023-05-02T06:00:00+05:30",
      end_datetime: "2023-05-02T14:00:00+05:30",
      start_time: "06:00 AM",
      end_time: "02:00 PM",
      start_meter: 600,
      end_meter: 608,
