-- ==============================================================================
-- Migration 052: Fix Operator QA Bugs & System Hardening
-- 1. Updates submit_operator_hour_log_atomic RPC Function:
--    - BUG-OP-07: Operator Identity Spoofing Guard: Verifies auth.uid() = p_operator_id unless caller is supervisor/admin.
--    - BUG-OP-05: Client-Machine Mismatch Guard: Validates that p_client_id matches machines.client_id.
--    - BUG-OP-08: Inactive / Maintenance Machine Guard: Rejects submissions on machines under maintenance or decommissioned.
--    - BUG-OP-03: Breakdown Duration Bounds Guard: Rejects breakdown duration exceeding total shift duration.
-- ==============================================================================
