-- ============================================================================
-- Migration 106: Fix Attendance Future Days & Detail RPCs
-- 0 new tables. Updates get_attendance_daily_detail and get_attendance_monthly_summary.
-- Ensures today (in progress) and future days without logs are marked DISABLED
-- and NEVER counted as ABSENT.
-- ============================================================================

-- 1. Daily Attendance Detail (per employee, per month)
...
-- 2. Monthly Attendance Summary (Ensure absent_days doesn't penalize current/future days)
