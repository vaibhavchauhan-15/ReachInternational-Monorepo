-- ============================================================================
-- Migration 111: Fix Attendance Scheduled and Present Days Alignment
-- 0 new tables. Updates get_attendance_monthly_summary RPC.
-- Ensures scheduled_days reflects total scheduled working days in the month
-- (weekdays excluding Sundays = 26 in Sep 2026), present_days strictly counts
-- scheduled weekdays with >= 4h work, guaranteeing present_days <= scheduled_days,
-- and aligns 100% with get_attendance_daily_detail.
-- ============================================================================
